...
private:
	...
	std::vector<std::function<std::unique_ptr<Animation>()>> m_animations;
...
public:
	...
	void addAnimationFactory(std::function<std::unique_ptr<Animation>()> factory) {
		//m_animationFactories.push_back(factory);
		m_animations.push_back(factory);
	}
